...
#include "xnnpack/packw.h"
  ...
  static void f32_gemm_minmax_ukernel_5x16c2__fma3_broadcast(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
      xnn_f32_gemm_minmax_ukernel_5x16c2__fma3_broadcast,
      xnn_init_f32_minmax_scalar_params,
      xnn_pack_f32_gemm_goi_w,
  ...
  BENCHMARK_GEMM(f32_gemm_minmax_ukernel_5x16c2__fma3_broadcast)
