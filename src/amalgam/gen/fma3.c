...
void xnn_f32_gemm_minmax_ukernel_5x16__fma3_broadcast_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    const float* restrict a,
...
void xnn_f32_gemm_minmax_ukernel_5x16_unrolling_prefetch__fma3_broadcast(
    size_t mr,
    size_t nc,
    size_t kc,
    const float* restrict a,
...
void xnn_f32_gemm_minmax_ukernel_5x16_unrolling_8_prefetch__fma3_broadcast(
    size_t mr,
    size_t nc,
    size_t kc,
    const float* restrict a,
